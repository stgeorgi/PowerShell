$pslocation = "C:\temp\20181105.1-1.0.0.1125\PowershellModules"
...
New-RdsTenant -Name $tenant -AadTenantId $aadid -FriendlyName "WVBOOTCAMP"  -Description "Administered by Stefan.Georgiev@micropsoft.com."
